...
|---|---|---|---|
| 🟫 | **Multi-agent simulation** — populate a sandbox or game with LLM agents and study what the population does | `Park 2023` | `Altera Team 2024` <br> `Ashery 2025` <br> `Larooij & Törnberg 2025` |
...
🐍 **Notebook:** [`4_smallville.ipynb`](../JN/week4/4_smallville.ipynb)
